...
//        showFocusFrame = true;
        ...
        controlFont = new FontUIResource("微软雅黑", Font.PLAIN, 15);
        systemFont = new FontUIResource("微软雅黑", Font.PLAIN, 15);
        userFont = new FontUIResource("微软雅黑", Font.PLAIN, 15);
        smallFont = new FontUIResource("微软雅黑", Font.PLAIN, 14);
        menuFont = new FontUIResource("微软雅黑", Font.PLAIN, 15);
        windowTitleFont = new FontUIResource("微软雅黑", Font.BOLD, 15);
    }
