...
public class MintDefaultTheme extends AbstractTheme {
    ...
    public FontUIResource getControlTextFont() {
        if (controlFont == null) {
            controlFont = new FontUIResource("微软雅黑", Font.PLAIN, 14);
        }
        return controlFont;
    }
    ...
    public FontUIResource getSystemTextFont() {
        if (systemFont == null) {
            systemFont = new FontUIResource("微软雅黑", Font.PLAIN, 14);
        }
        return systemFont;
    }
    ...
    public FontUIResource getUserTextFont() {
        if (userFont == null) {
            userFont = new FontUIResource("微软雅黑", Font.PLAIN, 14);
        }
        return userFont;
    }
    ...
    public FontUIResource getMenuTextFont() {
        if (menuFont == null) {
            menuFont = new FontUIResource("微软雅黑", Font.PLAIN, 14);
        }
        return menuFont;
    }
    ...
    public FontUIResource getWindowTitleFont() {
        if (windowTitleFont == null) {
            windowTitleFont = new FontUIResource("微软雅黑", Font.BOLD, 14);
        }
    ...
    public FontUIResource getSubTextFont() {
        if (smallFont == null) {
            smallFont = new FontUIResource("微软雅黑", Font.PLAIN, 12);
        }
        return smallFont;
    }
}
