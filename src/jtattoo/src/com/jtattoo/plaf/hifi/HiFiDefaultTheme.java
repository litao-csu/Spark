...
public class HiFiDefaultTheme extends AbstractTheme {
    ...
    public void setUpColor() {
        ...
        controlFont = new FontUIResource("微软雅黑", Font.BOLD, 14);
        systemFont = new FontUIResource("微软雅黑", Font.BOLD, 14);
        userFont = new FontUIResource("微软雅黑", Font.BOLD, 14);
        menuFont = new FontUIResource("微软雅黑", Font.BOLD, 14);
