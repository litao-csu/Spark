...
public class SparkTabbedPane extends JPanel {
	...
	for (int i = 0; i < pane.getTabCount(); ++i) {
		...
		if (SparkManager.getChatManager().getChatContainer().getChatRoom(i).getUnreadMessageCount() == 0)
		{
			...
			panel.setTitleFont(new Font("微软雅黑", Font.BOLD,
				15));
			panel.setTitleColor((Color) UIManager.get("Chat.activeTabColor"));
		    } else {
			panel.setTitleFont(new Font("微软雅黑", Font.PLAIN,
				15));
	...
	public void setTitleFontAt(int index, Font font) {
		...
		if (com instanceof TabPanel) {
			TabPanel panel = (TabPanel) com;
			panel.setTitleFont(new Font("微软雅黑", Font.PLAIN, 15));
		}
	}
	...
	private final Font defaultFontPlain = new Font("微软雅黑", Font.PLAIN, 13);
	private final Font defaultFontBold = new Font("微软雅黑", Font.BOLD, 13);
	...
	public TabPanel(final SparkTab sparktab, String title, Icon icon) {
	    ...
	    titleLabel.setFont(closeEnabled ? new Font("微软雅黑", Font.BOLD, 13)
	...
	public void setTitleBold(boolean bold) {
	    ...
	    Font newFont;
	    if (bold) {
		newFont = new Font("微软雅黑", Font.BOLD,
			12);
	    } else {
		newFont = new Font("微软雅黑", Font.PLAIN,
			12);
	    }
