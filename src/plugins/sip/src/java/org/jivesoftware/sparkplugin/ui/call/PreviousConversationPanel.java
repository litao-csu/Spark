...
public class PreviousConversationPanel extends JPanel {
    ...
    public PreviousConversationPanel() {
        ...
        currentCallLabel.setFont(new Font("微软雅黑", Font.BOLD, 15));
        ...
        previousLabel.setFont(new Font("微软雅黑", Font.BOLD, 15));
        ...
        today.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        oldConversation.setFont(new Font("微软雅黑", Font.BOLD, 14));
    ...
    public void addPreviousConversations(String phoneNumber) {
        ...
        for (HistoryCall call : calls){
            ...
            if (number.equals(TelephoneUtils.removeInvalidChars(phoneNumber))) {
                ...
                callLabel.setFont(new Font("微软雅黑", Font.PLAIN, 14));
                add(callLabel);
            }
        }
