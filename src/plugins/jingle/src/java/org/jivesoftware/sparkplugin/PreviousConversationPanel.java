...
public class PreviousConversationPanel extends JPanel {
    ...
    public PreviousConversationPanel() {
        ...
        currentCallLabel.setFont(new Font("微软雅黑", Font.BOLD, 14));
        ...
        previousLabel.setFont(new Font("微软雅黑", Font.BOLD, 14));

        statusLabel.setFont(new Font("微软雅黑", Font.BOLD, 13));

        // Add Duration timer
        durationLabel = new TimeTrackingLabel(new Date(), this);
        durationLabel.setFont(new Font("微软雅黑", Font.BOLD, 13));
        ...
        today.setFont(new Font("微软雅黑", Font.PLAIN, 13));
        ...
        oldConversation.setFont(new Font("微软雅黑", Font.BOLD, 13));
